...
var produtosLocal = localStorage.setItem("produtos", JSON.stringify(listaGiftCard));

function reescrever(){
    lista.innerHTML = "";
    var arrayRecuperado = localStorage.getItem("produtos");
    var meuArray = JSON.parse(arrayRecuperado);
